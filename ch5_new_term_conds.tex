\chapter{New termination conditions for the first-order PLGD algorithm for noisy phase retrieval}  \label{Sec:PLGD_term_crit}
...
\begin{figure}[H]
\centering
\hbox{\hspace{-2.1cm} \includegraphics[scale=0.6]{term_crit-pr_and_dual} }\vspace{-1.3cm}
