...
Corollary \ref{Cor:PLGD-primal_recovery_refinement} allows us to recover a signal $x$ by using the dual variable $y$ to denoise the noisy observation $b = \bar{b} + \eta$.
